...
{
    public class PlatformerCharacter2D_AltSwing : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            if (horizontalInput < 0f || horizontalInput > 0f)
            {
                ...
                else
                {
                    ...
                    if (groundCheck || m_AirControl)
                    {
                        ...
                        m_Rigidbody2D.AddForce(new Vector2((horizontalInput * groundForce - m_Rigidbody2D.linearVelocity.x) * groundForce, 0));
            ...
            if (!isSwinging)
            {
                ...
                if (isJumping)
                {
                    m_Rigidbody2D.linearVelocity = new Vector2(m_Rigidbody2D.linearVelocity.x, jumpSpeed);
                }
            }
        }
        void Update()
